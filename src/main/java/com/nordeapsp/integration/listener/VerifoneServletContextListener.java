package com.nordeapsp.integration.listener;
...
public class VerifoneServletContextListener implements ServletContextListener {
    ...
    private static final String SHOP_KEYSTORE_FILE = "demo-merchant-agreement-private.pem";
     ...
     */
    public VerifoneServletContextListener() {
       /* super();
        ...
        try {
            ...
            System.out.println("shopPrivateKey    :"+shopPrivateKey.getAlgorithm());
            System.out.println("paymentPagePublicKey    :"+paymentPagePublicKey.getAlgorithm());
        } catch (Exception e) {
...
*/
    ...
    /*private KeyStore loadKeyStoreFomResources(final String filename, final String keyStoretype,
        ...
        try {
        	System.out.println("Inside Load Key Store Form Resources ...  " + filename);
    ...
    public PrivateKey getShopPrivateKey() {
		return shopPrivateKey;
	}

	public void setShopPrivateKey(PrivateKey shopPrivateKey) {
		this.shopPrivateKey = shopPrivateKey;
	}

	public PublicKey getPaymentPagePublicKey() {
		return paymentPagePublicKey;
	}

	public void setPaymentPagePublicKey(PublicKey paymentPagePublicKey) {
		this.paymentPagePublicKey = paymentPagePublicKey;
	}
